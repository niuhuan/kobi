...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1435467979;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__api__cache_image_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__api__clean_cache_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__api__collect_from_account_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__api__collect_to_account_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__api__comic_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__api__comic_chapter_data_impl(port, ptr, rust_vec_len, data_len),
        ...
        12 => wire__crate__api__api__copy_image_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__api__delete_all_comic_view_logs_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__api__delete_comic_view_log_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__api__delete_download_comic_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__api__desktop_root_impl(port, ptr, rust_vec_len, data_len),
        17 => {
            wire__crate__api__api__download_comic_chapters_impl(port, ptr, rust_vec_len, data_len)
        }
        18 => wire__crate__api__api__download_comic_groups_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__api__download_comic_pages_impl(port, ptr, rust_vec_len, data_len),
        ...
        24 => wire__crate__api__api__explore_by_author_name_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__api__explorer_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__api__exports_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__api__find_comic_view_log_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__api__get_api_host_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__api__get_proxy_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__api__http_get_impl(port, ptr, rust_vec_len, data_len),
        32 => {
            wire__crate__api__api__in_download_chapter_uuid_impl(port, ptr, rust_vec_len, data_len)
        }
        33 => wire__crate__api__api__init_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__api__init_login_state_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__api__list_comic_view_logs_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__api__load_property_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__api__login_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__api__rank_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__api__recommends_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__api__register_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__api__reset_fail_downloads_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__api__roasts_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__api__save_property_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__api__api__send_comment_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__api__api__set_api_host_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api__api__set_proxy_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__api__tags_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__api__view_chapter_page_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__api__api__view_comic_info_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
