...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1083111246;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        22 => wire__crate__api__api__get_proxy_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__api__http_get_impl(port, ptr, rust_vec_len, data_len),
        24 => {
            wire__crate__api__api__in_download_chapter_uuid_impl(port, ptr, rust_vec_len, data_len)
        }
        25 => wire__crate__api__api__init_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__api__init_login_state_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__api__list_comic_view_logs_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__api__load_property_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__api__login_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__api__rank_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__api__recommends_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__api__register_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__api__reset_fail_downloads_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__api__save_property_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__api__set_proxy_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__api__tags_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__api__view_chapter_page_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__api__view_comic_info_impl(port, ptr, rust_vec_len, data_len),
